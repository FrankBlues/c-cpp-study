...
#include "exception/MatricesException.h"
...
/// Utilities for  and GSL matrices
...
class DllExport Matrices
	...
	public:
		...
		gsl_matrix* convert2GSLMatrix(Matrix *matrix);
		Matrix* convertGSL2Matrix(gsl_matrix *matrix);
