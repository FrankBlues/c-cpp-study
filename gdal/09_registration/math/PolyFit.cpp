...
gsl_vector* PolyFit::PolyfitOneDimensionQuiet(int order, gsl_matrix *inData)
{
...
gsl_vector* PolyFit::PolyfitOneDimension(int order, gsl_matrix *inData)
{
	/// Fit one-dimensional n-1th order polynomial
	/**
	 * A gsl_matrix containing the independent and dependent variables is passed in the form: \n
...
gsl_vector* PolyFit::PolyfitOneDimensionSVD(int order, gsl_matrix *inData)
{	
	/// Fit one-dimensional n-1th order polynomial
	/**
	 * A gsl_matrix containing the independent and dependent variables is passed in the form: \n
...
gsl_matrix* PolyFit::PolyTestOneDimension(int order, gsl_matrix *inData, gsl_vector *coefficients)
{
...
gsl_matrix* PolyFit::PolyfitTwoDimension(int numX, int numY, int orderX, int orderY, gsl_matrix *inData)
{
...
gsl_matrix* PolyFit::PolyTestTwoDimension(int orderX, int orderY, gsl_matrix *inData, gsl_matrix *coefficients)
{
	/// Tests one dimensional polynomal equation, outputs measured and predicted values to a matrix.
...
gsl_matrix* PolyFit::PolyfitThreeDimension(int numX, int numY, int numZ, int orderX, int orderY, int orderZ, gsl_matrix *inData)
{
...
gsl_matrix* PolyFit::PolyTestThreeDimension(int orderX, int orderY, int orderZ, gsl_matrix *inData, gsl_matrix *coefficients)
{
...
void PolyFit::calcRSquaredGSLMatrix(gsl_matrix *dataXY)
{
	double sumX = 0;
	double sumY = 0;
...
double PolyFit::calcRSquaredGSLMatrixQuiet(gsl_matrix *dataXY)
{
	double sumX = 0;
	double sumY = 0;
...
void PolyFit::calcRMSErrorGSLMatrix(gsl_matrix *dataXY)
{
	double sqSum = 0;
...
void PolyFit::calcMeanErrorGSLMatrix(gsl_matrix *dataXY)
{
	double sum = 0;
...
double PolyFit::calcRMSErrorGSLMatrixQuiet(gsl_matrix *dataXY)
{
	double sqSum = 0;
...
double PolyFit::calcMeanErrorGSLMatrixQuiet(gsl_matrix *dataXY)
{
	double sum = 0;
