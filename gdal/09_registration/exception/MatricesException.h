...
#ifndef MatricesException_H
#define MatricesException_H
...
class DllExport MatricesException : public MathException
    {
    public:
        MatricesException();
        MatricesException(const char* message);
        MatricesException(std::string message);
    };
