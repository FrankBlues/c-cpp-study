...
#ifndef VectorsException_H
#define VectorsException_H
...
class DllExport VectorsException : public MathException
    {
    public:
        VectorsException();
        VectorsException(const char* message);
        VectorsException(std::string message);
    };
#endif
