...
#ifndef RegistrationException_H
#define RegistrationException_H
...
class DllExport RegistrationException : public BasicException
{
public:
	RegistrationException();
	RegistrationException(const char* message);
	RegistrationException(std::string message);
};
