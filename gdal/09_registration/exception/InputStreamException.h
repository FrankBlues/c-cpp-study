...
#ifndef InputStreamException_H
#define InputStreamException_H
...
class DllExport InputStreamException : public BasicException
	{
	public:
		InputStreamException();
		InputStreamException(const char* message);
		InputStreamException(std::string message);
	};
#endif
